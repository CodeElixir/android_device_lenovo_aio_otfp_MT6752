...
public class Battery {
    ...
    private static final String CHARGE_RATE = "/sys/kernel/charge_levels";
    private static final String CHARGE_RATE_ENABLE = CHARGE_RATE + "/quick_charge_enable";
    private static final String CUSTOM_AC_CURRENT = CHARGE_RATE + "/charge_level_ac";
    private static final String CUSTOM_USB_CURRENT = CHARGE_RATE + "/charge_level_usb";

    private static Integer sCapacity;

    public static void setACChargingCurrent(int value, Context context) {
    ...
    public static int getACChargingCurrent() {
    ...
    public static boolean hasACChargingCurrent() {
